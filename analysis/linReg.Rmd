...
Plotting this line show the effect of the particular gene(y) on starvation resistance(x)
...
This will need to be run over 24 thousand times to capture every gene expressed in both mfemales and males. 
