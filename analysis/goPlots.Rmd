...
gg[[1]] <- ggMake(dataF, 'F', 'Effect of R2 Selection on Accuracy by GO Term', 'GO Term', 'Prediction Accuracy')
gg[[2]] <- ggMake(dataM, 'M', 'Effect of R2 Selection on Accuracy by GO Term', 'GO Term', 'Prediction Accuracy')
gg[[3]] <- ggMake(data, 'A', 'Effect of R2 Selection on Accuracy by GO Term', 'GO Term', 'Prediction Accuracy')
