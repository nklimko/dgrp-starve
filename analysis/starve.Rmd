...
Two tables, starveF and starveM, were then joined into one.
Difference and average of each line were calculated and added

```{r 1-combineMF, eval=FALSE}
#Combine mf
...
# [Analysis of SR by Sex](../code/dgrpSR.R)
...
# [Selecting Ingroups](../code/fourLinePrep.R)
...
# [SNP Extraction](../code/baseScript-lineComp.R)
