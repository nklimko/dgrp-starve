...
library(BiocManager, lib.loc = "/data2/morgante_lab/nklimko/software/R/x86_64-pc-linux-gnu-library/4.1")

BiocManager::install("org.Dm.eg.db", dependencies=FALSE)

#library("org.Dm.eg.db")
#https://bioconductor.org/packages/release/data/annotation/manuals/org.Dm.eg.db/man/org.Dm.eg.db.pdf

#option a for all packages
##libtoolize -> lobotomize
